...
3. **Explore the conditional ES in the Virtual Historical Simulation (VHS)**

- @francq2020virtual estimate the conditional VaR using a standard GARCH model via Gaussian QML

- They derive an asymptotic theory for the conditional VaR in the VHS case.
